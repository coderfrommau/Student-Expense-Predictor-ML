...
* outings → Number of outings per month
* food_cost → Monthly food expense
* travel_cost → Monthly travel expense
* total_expense → Total monthly expense (target variable)
